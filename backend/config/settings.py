"""
Django settings for Hostel Marketplace project.
"""
import os
...
# Add connection timeout for PostgreSQL (prevents hanging on network issues)
...
# Media / Cloudinary - use os.environ directly to ensure Render env vars are read
